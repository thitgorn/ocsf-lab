...
public class ConnectionToClient extends Thread {
	...
	/**
	 * Sends an object to the client. This method can be overridden, but if so it
	 ...
	 * map.
	 *
	 * @param infoType identifies the type of information. This is used as key
	 * to the clientInfo hashmap
	 * @return value corresponding to the key infoTupe for this client.
	 */
		...
		try {
			...
			while (!readyToStop) {
				...
				try { // Added in version 2.31
					...
					if (!readyToStop && handleMessageFromClient(msg)) // Added in v.2.2
					{
