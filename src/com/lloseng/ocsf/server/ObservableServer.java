...
public class ObservableServer extends Observable {
	 ...
	 * @throws IOException if network or IO error
	 */
	 ...
	 * @return true if server is currently listening for client connections.
	 */
	 ...
	 * <code>stopListening</code>. This method may be overridden by subclasses.
	 *
	 * @param exception
	 *            the exception raised.
	 */
	 ...
	 * reason. This method may be overridden by subclasses.
	 */
	 ...
	 * are notified by receiving the transmitted message. Note that, in this
	 * implementation, the information concerning the client that sent the
	 * message is lost. It can be overridden, but is still expected to call
	 * notifyObservers().
	 *
	 * @param message
