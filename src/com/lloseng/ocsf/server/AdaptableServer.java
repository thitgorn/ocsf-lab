...
public class AdaptableServer extends AbstractServer
{
   ...
   *
   * @param  server  reference to an ObservableServer object
   * @param  port  the port number, passed to ObservableServer
   */
...
// OVERRIDDEN METHODS ---------
   ...
   * Applications can override this method in order to receive
   * notification whenever a client disconnects.
   *
